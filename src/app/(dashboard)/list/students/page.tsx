...
const StudentListPage = async ({
  ...
  const renderRow = (item: StudentList) => {
    // Extract grade from class name (handles R, 1-12)
    const gradeMatch = item.class.name.match(/^(R|\d+)/);
    const gradeDisplay = gradeMatch ? gradeMatch[1] : "N/A";
    ...
    return (
      ...
      >
        ...
        <td className="hidden md:table-cell">{gradeDisplay}</td>
