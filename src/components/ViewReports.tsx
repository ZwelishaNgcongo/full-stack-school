...
const ViewReports = ({ setOpen }: ViewReportsProps) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-800">View Term Reports</h2>
          <p className="text-sm text-gray-500">Enter student ID to view term marks and reports</p>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex gap-2">
          <div>
            <p className="text-sm text-blue-800 font-medium">About Term Reports</p>
            <p className="text-xs text-blue-600 mt-1">
              View detailed term marks for all subjects including grades, teacher comments, and academic progress across all four terms.
            </p>
          </div>
        </div>
      </div>
